...
directory_name = 'C:\\file_struct\\documents\\programming\\data\\airflow_financial_project\\hist\\'+ str(datetime.date.today())
...
with open(os.devnull, 'w') as devnull:
    with contextlib.redirect_stdout(devnull):
        for i in range(offset, end):
            ...
            is_valid[i] = True
            data.to_csv('C:\\file_struct\\documents\\programming\\data\\airflow_financial_project\\hist\\'+ str(datetime.date.today())+'\\{}.csv'.format(s))
